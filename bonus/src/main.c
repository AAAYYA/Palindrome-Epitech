...
void helper(void)
{
    ...
    printf(" (>=0) [def: 100]\n");
    printf("\t-l --list\tlist the steps before "
    "obtaining a palindrome\n");
    printf("\t-r --random\tuse a random number for n (>=0)\n");
    printf("\t-o --save\tsaves the output to an output file\n");
    printf("\t-c --count\tcounts the steps for the -l\n");
}
